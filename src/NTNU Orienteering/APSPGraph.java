...
class APSPGraph {
    ...
    /**
     * Initialise graph to find all pair shortest path with distance.
     * 
     * @param nodes The number of nodes in the graph.
     * @param edges The number of edges in the graph.
    ...
    /**
     * Initialise graph to find all pair shortest path distance only. No path
     * pointer array will be initialised.
     * 
     * @param nodes The number of nodes in the graph.
     * @param edges The number of edges in the graph.
     * @return The graph with given number of nodes and edges.
    ...
    void addEdge(final int u, final int v, final double w) {
        if (!isSPDone) {
            ...
            throw new UnsupportedOperationException(
                    "Cannot add edges to the graph after performing Floyd-Warshall algorithm.");
        }
    }
